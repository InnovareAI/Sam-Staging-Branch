  ...
  return (
    <aside className="fixed start-0 top-0 flex min-h-screen inset-y-0 left-0 z-10 w-20 flex-col border-r bg-background pt-2">
      <nav className="flex flex-col items-center gap-4">
        <Link
          href="#"
          className="group w-full aspect-square flex shrink-0 rounded-lg items-center justify-center gap-2 bg-black/90 dark:bg-white/20 text-lg font-semibold text-primary-foreground md:text-base md:h-12 md:w-12"
        >
          <Image
            src="/logo.svg"
            width={24}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="/contacts"
                className={cn(
                  "flex h-9 w-9 items-center justify-center rounded-lg text-accent-foreground transition-colors hover:text-foreground md:h-10 md:w-10",
