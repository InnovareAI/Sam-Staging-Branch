...
import { Mail, X, Plus, Trash2, CheckCircle, AlertCircle, RefreshCw, Settings as SettingsIcon } from 'lucide-react';
      ...
      const response = await fetch('/api/email-providers', {
        ...
        body: JSON.stringify({
          ...
          config: {
            ...
            password: smtpForm.smtp_password, // Should be encrypted on backend
