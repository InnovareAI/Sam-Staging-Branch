      ...
      {filteredPosts.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredPosts.map((post) => (
            <div
              key={post.id}
              className="bg-surface-muted rounded-xl border border-border overflow-hidden hover:border-gray-600 transition-colors"
            >
              {/* Post Header */}
              ...
              {!post.comment && post.status === 'discovered' && (
                <div className="p-3 bg-background/30 border-t border-border text-center">
