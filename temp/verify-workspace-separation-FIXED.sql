-- ============================================================================
-- WORKSPACE SEPARATION & MEMBERSHIP VERIFICATION SCRIPT (FIXED)
-- ============================================================================
-- Purpose: Verify workspace isolation and member access controls
-- Date: November 9, 2025
-- Fixed: Removed non-existent columns (created_at, created_by)
-- ============================================================================
...
-- ============================================================================
-- PART 11: CHECK workspace_members TABLE SCHEMA
-- ============================================================================

SELECT '=== workspace_members TABLE SCHEMA ===' AS section;

-- Show actual columns in workspace_members table
SELECT
  column_name,
  data_type,
  is_nullable,
