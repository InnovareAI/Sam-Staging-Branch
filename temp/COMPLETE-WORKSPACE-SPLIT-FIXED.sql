...
-- Temporarily disable the auto_assign_client_code trigger
ALTER TABLE workspaces DISABLE TRIGGER IF EXISTS auto_assign_client_code_trigger;
...
UPDATE workspaces
SET name = 'IA1', client_code = 'IA1'
WHERE id = 'babdcab8-1a78-4b2f-913e-6e9fd9821009';

-- 2. Create IA2 (Michelle)
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('04666209-fce8-4d71-8eaf-01278edfc73b', 'IA2', 'IA2', NOW(), NOW());

-- 3. Create IA3 (Irish)
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('96c03b38-a2f4-40de-9e16-43098599e1d4', 'IA3', 'IA3', NOW(), NOW());

-- 4. Create IA4 (Charissa)
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('7f0341da-88db-476b-ae0a-fc0da5b70861', 'IA4', 'IA4', NOW(), NOW());

-- 5. Create IA5 (Jennifer)
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('cd57981a-e63b-401c-bde1-ac71752c2293', 'IA5', 'IA5', NOW(), NOW());

-- 6. Create IA6 (Chona)
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('2a8f7c3d-9b1e-4f6a-8c2d-5e9a1b4f7d3c', 'IA6', 'IA6', NOW(), NOW());
...
INSERT INTO workspaces (id, name, client_code, created_at, updated_at)
VALUES ('cf27fd56-2350-4bef-9c0b-9508463a1646', 'SC1', 'SC1', NOW(), NOW());

-- Rename original Sendingcell to SC2 for Dave
UPDATE workspaces
SET name = 'SC2', client_code = 'SC2'
...
ALTER TABLE workspaces ENABLE TRIGGER IF EXISTS auto_assign_client_code_trigger;
