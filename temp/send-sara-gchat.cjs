...
const WEBHOOK_URL = 'https://chat.googleapis.com/v1/spaces/AAAAv1JMuHQ/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=hnZM4s0nKEaWN6v5jPJwMGPGvHO2H4lsGYKgLpM2jNg';
  ...
  cardsV2: [{
    ...
    card: {
      ...
      sections: [
        ...
        {
          header: 'Suggested Reply (Updated)',
          widgets: [{
