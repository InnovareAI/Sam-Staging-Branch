(()=>{var a={};a.id=8887,a.ids=[8887],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},11997:a=>{"use strict";a.exports=require("punycode")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},27910:a=>{"use strict";a.exports=require("stream")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},55591:a=>{"use strict";a.exports=require("https")},63033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},74075:a=>{"use strict";a.exports=require("zlib")},78335:()=>{},79428:a=>{"use strict";a.exports=require("buffer")},79551:a=>{"use strict";a.exports=require("url")},81630:a=>{"use strict";a.exports=require("http")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},91067:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>F,patchFetch:()=>E,routeModule:()=>A,serverHooks:()=>D,workAsyncStorage:()=>B,workUnitAsyncStorage:()=>C});var d={};c.r(d),c.d(d,{GET:()=>z,POST:()=>y});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641),v=c(91788),w=c(82461),x=c(86802);async function y(a){try{let b=(0,x.UL)(),c=(0,v.createRouteHandlerClient)({cookies:()=>b}),{email:d,password:e,firstName:f,lastName:g}=await a.json();if(!d||!e||!f||!g)return u.NextResponse.json({error:"All fields are required"},{status:400});if(e.length<6)return u.NextResponse.json({error:"Password must be at least 6 characters long"},{status:400});console.log("Creating user with Supabase Auth:",{email:d,firstName:f,lastName:g});let{data:h,error:i}=await c.auth.signUp({email:d,password:e,options:{data:{first_name:f,last_name:g},emailRedirectTo:"https://app.meet-sam.com/auth/callback"}});if(i){if(console.error("Supabase signup error:",i),i.message.includes("User already registered"))return u.NextResponse.json({error:"User already exists with this email address"},{status:409});return u.NextResponse.json({error:i.message},{status:400})}if(h.user&&!h.session)return u.NextResponse.json({message:"Registration successful! Please check your email to verify your account.",requiresVerification:!0,email:d});if(h.session&&h.user){console.log("User created successfully:",h.user.id);try{let a=(0,w.UU)("https://latxadqrvrrrcvkktrog.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY),{error:b}=await a.from("users").insert({id:h.user.id,clerk_id:h.user.id,email:h.user.email,first_name:f,last_name:g,created_at:new Date().toISOString()});b&&!b.message.includes("duplicate key")&&console.error("Profile creation error:",b)}catch(a){console.error("Error creating user profile:",a)}return u.NextResponse.json({message:"Registration successful! You are now logged in.",user:{id:h.user.id,email:h.user.email,firstName:f,lastName:g}})}return u.NextResponse.json({message:"Registration initiated. Please complete the verification process.",requiresVerification:!0})}catch(a){return console.error("Signup API error:",a),u.NextResponse.json({error:"Internal server error during registration"},{status:500})}}async function z(){let a=`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
