(()=>{var a={};a.id=792,a.ids=[792],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},11997:a=>{"use strict";a.exports=require("punycode")},12412:a=>{"use strict";a.exports=require("assert")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},27910:a=>{"use strict";a.exports=require("stream")},28354:a=>{"use strict";a.exports=require("util")},29021:a=>{"use strict";a.exports=require("fs")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},33873:a=>{"use strict";a.exports=require("path")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},55511:a=>{"use strict";a.exports=require("crypto")},55591:a=>{"use strict";a.exports=require("https")},57029:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>F,patchFetch:()=>E,routeModule:()=>A,serverHooks:()=>D,workAsyncStorage:()=>B,workUnitAsyncStorage:()=>C});var d={};c.r(d),c.d(d,{POST:()=>z});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641),v=c(82461),w=c(13333);let x=(0,v.UU)("https://latxadqrvrrrcvkktrog.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY),y=new w.hA(process.env.POSTMARK_SERVER_TOKEN);async function z(a){try{let{email:b,workspaceId:c,role:d="member"}=await a.json();if(!b||!c)return u.NextResponse.json({error:"Email and workspace ID required"},{status:400});let{data:e,error:f}=await x.from("workspaces").select("name, owner_id, users!workspaces_owner_id_fkey(first_name, last_name, email)").eq("id",c).single();if(f||!e)return u.NextResponse.json({error:"Workspace not found"},{status:404});let{data:g}=await x.from("users").select("id").eq("email",b).single(),h=null,i=!g;if(g){let{data:a}=await x.from("workspace_members").select("id").eq("workspace_id",c).eq("user_id",g.id).single();if(a)return u.NextResponse.json({error:"User already a member"},{status:400});await x.from("workspace_members").insert({workspace_id:c,user_id:g.id,role:d})}else h=`invite_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,await x.from("workspace_invites").insert({email:b,workspace_id:c,role:d,token:h,invited_by:e.owner_id,expires_at:new Date(Date.now()+6048e5).toISOString()});let j=Array.isArray(e.users)?e.users[0]:e.users,k=`${j?.first_name||""} ${j?.last_name||""}`.trim()||j?.email,l=i?{To:b,From:"noreply@meet-sam.com",Subject:`You're invited to join ${e.name} on SAM AI`,HtmlBody:`
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="color: #6B7280; font-size: 14px; text-align: center;">
            This invitation was sent to ${b}. If you didn't expect this email, you can safely ignore it.
          </p>
        </div>
      `,MessageStream:"outbound"}:{To:b,From:"noreply@meet-sam.com",Subject:`You've been added to ${e.name} on SAM AI`,HtmlBody:`
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #7C3AED; margin: 0;">SAM AI</h1>
            <p style="color: #6B7280; margin: 5px 0;">AI-Powered Sales Assistant Platform</p>
