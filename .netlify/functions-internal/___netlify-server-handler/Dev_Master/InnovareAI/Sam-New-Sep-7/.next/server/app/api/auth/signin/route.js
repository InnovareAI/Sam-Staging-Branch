(()=>{var a={};a.id=957,a.ids=[957],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},11997:a=>{"use strict";a.exports=require("punycode")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},27910:a=>{"use strict";a.exports=require("stream")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},55591:a=>{"use strict";a.exports=require("https")},63033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},74075:a=>{"use strict";a.exports=require("zlib")},78335:()=>{},79551:a=>{"use strict";a.exports=require("url")},81630:a=>{"use strict";a.exports=require("http")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},90619:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>D,patchFetch:()=>C,routeModule:()=>y,serverHooks:()=>B,workAsyncStorage:()=>z,workUnitAsyncStorage:()=>A});var d={};c.r(d),c.d(d,{GET:()=>x,POST:()=>w});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641);let v=(0,c(82461).UU)("https://latxadqrvrrrcvkktrog.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxhdHhhZHFydnJycmN2a2t0cm9nIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI2OTk5ODYsImV4cCI6MjA2ODI3NTk4Nn0.3WkAgXpk_MyQioVf_SED9O_ArjcT9nH0uy9we2okftE");async function w(a){try{let{email:b,password:c}=await a.json();if(!b||!c)return u.NextResponse.json({error:"Email and password are required"},{status:400});console.log("Signing in user with Supabase Auth:",{email:b});let{data:d,error:e}=await v.auth.signInWithPassword({email:b,password:c});if(e){if(console.error("Supabase signin error:",e),e.message.includes("Invalid login credentials"))return u.NextResponse.json({error:"Invalid email or password"},{status:401});if(e.message.includes("Email not confirmed"))return u.NextResponse.json({error:"Please verify your email address before signing in"},{status:401});return u.NextResponse.json({error:e.message},{status:400})}if(d.session&&d.user)return console.log("User signed in successfully:",d.user.id),u.NextResponse.json({message:"Sign-in successful!",user:{id:d.user.id,email:d.user.email,firstName:d.user.user_metadata?.first_name,lastName:d.user.user_metadata?.last_name},session:{access_token:d.session.access_token,refresh_token:d.session.refresh_token,expires_at:d.session.expires_at}});return u.NextResponse.json({error:"Sign-in failed - no session created"},{status:400})}catch(a){return console.error("Signin API error:",a),u.NextResponse.json({error:"Internal server error during sign-in"},{status:500})}}async function x(){let a=`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
